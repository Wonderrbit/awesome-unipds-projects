...
- [ErickWendel/localstudio](https://github.com/ErickWendel/localstudio) - `📇` `🏠` `🔗` - Browser-only Canva-style presentation studio, powered by local Web AI. **by [@ErickWendel](https://github.com/ErickWendel)**
